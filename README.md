...
3 Seasonal model
4 SARIMAX model that is combination of all

I have used multiple datasets the two in this directory are the prices of NIFTY50. I tried a lot predicting the future value but i couldnt find  as the value donot have any correlation and are quite random 
this result is evident from the ACF graph.
